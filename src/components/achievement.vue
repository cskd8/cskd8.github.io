    ...
    <div class="txt">
      <div class="achievement">
          ...
          <ul>
            ...
            <li><a href="https://isucon.net/archives/56021237.html">ISUCON11</a> - 予選学生3位、全体35位 本戦出場</li>
          </ul>
          <br>
          <br>
          <router-link to="/"><div class="item"><div class="link">Home</div></div></router-link>
      </div>
    </div>
  </div>
</template>
